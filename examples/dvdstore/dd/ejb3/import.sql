...
insert into ORDERS (ORDERID,ORDERDATE,USERID,NETAMOUNT,TAX,TOTALAMOUNT,TRACKING,STATUS) VALUES (1,now(),2,14,3,17,null,0)
insert into ORDERS (ORDERID,ORDERDATE,USERID,NETAMOUNT,TAX,TOTALAMOUNT,TRACKING,STATUS) VALUES (2,now(),2,24,5,29,null,0)
