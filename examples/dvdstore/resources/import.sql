...
insert into PRODUCTS (PROD_ID, CATEGORY, TITLE, ACTOR, PRICE, DESCRIPTION) values (1, 2, 'Life is Beautiful', 'Roberto Benini', 12.0, 'In 1930s Italy, a carefree Jewish book keeper named Guido starts a fairy tale life by courting and marrying a lovely woman from a nearby city. Guido and his wife have a son and live happily together until the occupation of Italy by German forces. In an attempt to hold his family together and help his son survive the horrors of a Jewish Concentration Camp, Guido imagines that the Holocaust is a game and that the grand prize for winning is a tank.');
insert into PRODUCTS (PROD_ID, CATEGORY, TITLE, ACTOR, PRICE, DESCRIPTION) values (2, 3, 'Finding Nemo', 'Albert Brooks', 22.49, 'Marlin (a clown fish) is a widower who only has his son Nemo left of his family after a predator attack. Years later, on Nemo''s first day of school, he''s captured by a scuba diver and taken to live in a dentist office''s fish tank. Marlin and his new absent-minded friend Dory set off across the ocean to find Nemo, while Nemo and his tankmates scheme on how to get out of the tank before he becomes the dentist''s niece''s new pet.');
