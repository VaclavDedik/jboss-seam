  ...
  <body>
   <h:form>
     ...
     <fieldset class="rvgFieldSet">
       <legend><h:outputText value="#{msg.LoginDetails}"/></legend>
       ...
       <span class="rvgActions">
         <h:commandButton type="submit" value="#{msg.Login}" action="#{login.login}"/>
         <h:commandButton type="submit" value="#{msg.Register}" action="editUser"/>
       </span>
