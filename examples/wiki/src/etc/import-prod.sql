...
insert into PREFERENCE(PREF_ID, OBJ_VERSION, COMPONENT_NAME, PROPERTY_NAME, BOOLEAN_VALUE)  values (7, 0, 'docEditorPreferences', 'minorRevisionEnabled', true)
insert into PREFERENCE(PREF_ID, OBJ_VERSION, COMPONENT_NAME, PROPERTY_NAME, LONG_VALUE)     values (8, 0, 'docEditorPreferences', 'regularEditAreaRows', '25')
insert into PREFERENCE(PREF_ID, OBJ_VERSION, COMPONENT_NAME, PROPERTY_NAME, LONG_VALUE)     values (9, 0, 'docEditorPreferences', 'regularEditAreaColumns', '80')
insert into PREFERENCE(PREF_ID, OBJ_VERSION, COMPONENT_NAME, PROPERTY_NAME, LONG_VALUE)     values (10, 0, 'docEditorPreferences', 'previewEditAreaRows', '7')
insert into PREFERENCE(PREF_ID, OBJ_VERSION, COMPONENT_NAME, PROPERTY_NAME, LONG_VALUE)     values (11, 0, 'docEditorPreferences', 'previewEditAreaColumns', '80')
...
insert into PREFERENCE(PREF_ID, OBJ_VERSION, COMPONENT_NAME, PROPERTY_NAME, STRING_VALUE)   values (21, 0, 'feedTeasersPreferences', 'teaserTitle', 'Site news feed:')
insert into PREFERENCE(PREF_ID, OBJ_VERSION, COMPONENT_NAME, PROPERTY_NAME, LONG_VALUE)     values (22, 0, 'feedTeasersPreferences', 'feedIdentifier', '1')
insert into PREFERENCE(PREF_ID, OBJ_VERSION, COMPONENT_NAME, PROPERTY_NAME, LONG_VALUE)     values (23, 0, 'feedTeasersPreferences', 'numberOfTeasers', '5')
