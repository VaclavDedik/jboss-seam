 ...
 * Component-Family org.jboss.seam.ui.SelectDate
  	 ...
  	 * Deprecated.  You should use &amp;lt;rich:calendar /&amp;gt; instead.
 */
...
// Component properties fields
	 ...
	 */
	 	 private Integer  _firstDayOfWeek = null; /* Default is null*/
	 	  	/**
	 * dateFormat
	 * 
	 */
...
// Getters-setters
   ...
   /**
	 ...
	 */
	 public void setFirstDayOfWeek( Integer  __firstDayOfWeek ){
   ...
   /**
	 * Set to override the default first day of week
	 * Getter for firstDayOfWeek
	 * @return firstDayOfWeek value from local variable or value bindings
	 */
        ...
        values[0] = super.saveState(context);
 	        values[1] = new Integer(_endYear);
	   	   ...
	   	   values[4] = Boolean.valueOf(_startYearSet);	
  	 	          ...
  	 	          values[6] = _firstDayOfWeek;
	   	 	
  	 	          values[7] = _dateFormat;
        ...
        super.restoreState(context, values[0]);
 	        _endYear = ((Integer)values[1]).intValue();
	   	   ...
	   	   _startYearSet = ((Boolean)values[4]).booleanValue();	
  	 	          ...
  	 	          _firstDayOfWeek = (Integer)values[6] ;
	   	 	
  	 	          _dateFormat = (String)values[7] ;
	   	 	
  	 	          _style = (String)values[8] ;
	   	 	
      	 	          _for = (String)values[9] ;
